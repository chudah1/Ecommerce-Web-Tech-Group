...
<head>
    <title>Tranquillo - About Page</title>
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-white">
                    <h1>About Us</h1>
                    <p>
                       Tranquillo is an ecommerce platform for students. It offers a wide range of products and exceptional customer service with a 24/7 support team. The platform is user-friendly, secure and offers convenient payment, quick delivery and easy returns. Tranquillo's mission is to make student life easier by providing a one-stop-shop for all shopping needs. Thank you for choosing Tranquillo.
                    </p>
                </div>
                <div class="col-md-4">
    ...
    <section class="container py-5">
        <div class="row text-center pt-5 pb-3">
            <div class="col-lg-6 m-auto">
                ...
                <p>
                    Elevated efficiency, unparalleled service.
                </p>
            </div>
        </div>
        <div class="row">
